...
int main (int argc, char *argv[])
{
  ...
  //Pipeline
    ...
    file <<"EndIf(${OutputDir})"<<std::endl;
    file <<""<<std::endl;
    file <<"GetFilename(movingVolumeHead ${movingVolume} NAME_WITHOUT_EXTENSION)"<<std::endl;
    file <<"GetFilename(movingVolumeTail ${movingVolume} NAME)"<<std::endl;
    file <<""<<std::endl;
    ...
    file <<"#  exit()"<<std::endl;
    file <<"Endif(${errorDiffusionTensorMathematics})"<<std::endl;
    file <<""<<std::endl;
    ...
    file <<"EndIf (${fixedMaskVolume})"<<std::endl;
    file <<""<<std::endl;
    ...
    file <<"#    exit()"<<std::endl;
    file <<"  Endif(${errorMask})"<<std::endl;
    file <<"EndIf(${movingMaskVolume})"<<std::endl;
    file <<""<<std::endl;
    file <<""<<std::endl;
  ...
  if (!method.compare("useScalar-ANTS"))
    ...
    file <<"# Registration via ANTS"<<std::endl;
    file <<""<<std::endl;
    file <<"echo()"<<std::endl;
    file <<"echo('Registration...')"<<std::endl;
    file <<"set(Transform '')"<<std::endl;
    file <<"set (DeformationField '')"<<std::endl;
    file <<""<<std::endl;
    ...
    file <<"#  exit()"<<std::endl;
    file <<"Endif(${errorWarpTensorImageMultiTransform})"<<std::endl;
    file <<""<<std::endl;
    ...
    file <<"#  exit()"<<std::endl;
    file <<"Endif(${errorResampleDTI})"<<std::endl;
    file <<""<<std::endl;
    file <<"#Delete temporary files"<<std::endl;
    file <<"#If (${outputVolume} == '')"<<std::endl;
